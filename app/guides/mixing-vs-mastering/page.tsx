...
export default function MixingVsMasteringPage() {
  return (
    <div className="min-h-screen px-6 md:px-20 lg:px-40 py-16 md:py-24">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Mixing vs Mastering: Key Differences Explained","description":"Understand the difference between mixing and mastering.","datePublished":"2026-05-24","author":{"@type":"Organization","name":"Audio Software Hub"}}) }} />
