...
export default function WhatIsADawPage() {
  return (
    <div className="min-h-screen px-6 md:px-20 lg:px-40 py-16 md:py-24">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"Article","headline":"What is a DAW? The Ultimate Guide to Digital Audio Workstations"},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do I need an expensive computer?","acceptedAnswer":{"@type":"Answer","text":"No. Mid-range laptops with SSD and 8GB RAM run DAWs well."}},{"@type":"Question","name":"Can I use a DAW without an audio interface?","acceptedAnswer":{"@type":"Answer","text":"Yes, but an interface improves sound quality and reduces latency."}},{"@type":"Question","name":"Which DAW is easiest for beginners?","acceptedAnswer":{"@type":"Answer","text":"Ableton Live and FL Studio have gentle learning curves."}},{"@type":"Question","name":"Are plugins cross-DAW compatible?","acceptedAnswer":{"@type":"Answer","text":"Yes, VST3 plugins work across all major DAWs."}}]}],"description":"A complete beginner guide to DAWs.","datePublished":"2026-05-24","author":{"@type":"Organization","name":"Audio Software Hub"}})}} />
